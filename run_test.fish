...
set RC_URL (dotenv -f $ENV_FILE get MS_RC_URL 2>/dev/null; or echo "http://localhost:3001") # Read from .env or default
...
set -x PARAMS_P_HEX $PARAMS_P_HEX
set -x PARAMS_P_PUB_HEX $PARAMS_P_PUB_HEX
set -x PARAMS_P_PUB_HAT_HEX $PARAMS_P_PUB_HAT_HEX
set -x PARAMS_G_HEX $PARAMS_G_HEX
set -x USK_R_U_HEX $USK_R_U_HEX
set -x USK_SID_U_HEX $USK_SID_U_HEX
